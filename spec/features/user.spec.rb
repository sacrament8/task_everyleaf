...
RSpec.feature "ユーザー関連", type: :feature do
  ...
  feature "Adminユーザー関連" do
    ...
    context "管理者ユーザーとしてログイン後のテスト" do
      background do
        @admin_user = create(
          :admin_user,
          name: "アドミンユーザーA",
        ...
        visit new_session_path
        fill_in "sign_in_email", with: "ad@test.com"
        fill_in "sign_in_pass", with: "111111"
        find("#sign_in_btn").click
      end
      ...
      scenario "2ユーザー作成してユーザー一覧をみると登録ユーザー全ての名前とタスク数が表示されている" do
        create(:user, name: 'fugafuga', email: 'test99@test.com', admin: false)
        @user = create(:user, name: 'hogehoge', email: 'test88@test.com', admin: true)
